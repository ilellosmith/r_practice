...
setwd("~/r_practice/monte_carlo/logistic_regression/multicollinearity/")
source('~/r_practice/monte_carlo/helper_functions/diagnostic_plots/estimate_histogram_generator.R')
source('~/r_practice/monte_carlo/helper_functions/diagnostic_plots/coverage_calculator.R')
source('~/r_practice/monte_carlo/helper_functions/diagnostic_plots/coverage_plot_generator.R')
library(tidyverse)
library(pracma)
library(mvtnorm)
library(ggcorrplot)
