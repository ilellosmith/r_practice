...
knitr::kable(assumptions, caption = 'Logistic Regression Assumptions', format = 'latex')
```
...
- You can find my full code [here.](https://github.com/ilellosmith/r_practice/tree/master/monte_carlo)  
